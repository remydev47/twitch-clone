...
const styles ={
    ...
    middleWrapper:`flex bg-gray-400 text-white justify-center items-center max-w-[400px] m-auto p-2 rounded-2xl`,
    ...
    accountContainer:`px-4 py-[6px] font-bold rounded-xl bg-[#9147FF]`
}